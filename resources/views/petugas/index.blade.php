                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{ count($pengaduan->where('jenis', Auth::user()->jenis)->where('status', '!=', 'cancelled')->where('status', '!=', '0')) }}
                                </div>
                            </div>
                            <div class="col-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
                                    class="bi bi-card-list text-gray-300" viewBox="0 0 16 16">
                                    <path
            ...
            <div class="col-xl-3 mb-4">
                <div class="card border-left-danger shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Belum di Tanggapi
                                </div>
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                            {{ count($pengaduan->where('jenis', Auth::user()->jenis)->where('status', 'proses')) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
                                    class="bi bi-clipboard2-x-fill text-gray-300" viewBox="0 0 16 16">
                                    <path
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                    Tanggapan</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{ count($pengaduan->where('status', 'selesai')->where('jenis', Auth::user()->jenis)) }}
                                </div>
                            </div>
                            <div class="col-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
